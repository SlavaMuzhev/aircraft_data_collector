...
class APIAdapter(BaseApiAdapter):
    ...
    def __init__(self, country: str) -> None:
        ...
        self.__coordinate: Optional[List[float]] = None
        self.__aeroplanes: Optional[Dict[str, Any]] = None

    def get_coordinate(self, country: Optional[str] = None) -> None:
    ...
    def get_airplanes(self) -> None:
        ...
        params = {
            "lamin": self.__coordinate[0],
            "lamax": self.__coordinate[1],
            "lomin": self.__coordinate[2],
            "lomax": self.__coordinate[3],
        }
    ...
    @property
    def coordinate(self) -> Optional[List[float]]:
